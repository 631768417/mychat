...
//'my_serialno','tablename','id'	//信息内容表
type Tim_serialno struct {
	tablename string
	id        int64
}

//'my_message','id','stamp','chatid','fromuser','touser','msgtype','msgmode','gname','small','large','stanza','createtime','Index'	//信息内容表
...
//'my_offline','id','mid','domain','username','stamp','fromuser','msgtype','msgmode','gname','message_size','stanza','createtime','index'	//离线消息存储表
...
//// 'my_domain','id','domain','createtime','remark' //域名表
...
////'my_config','id','keyword','valuestr','createtime','remark' //配置表
...
////'my_property','id','keyword','valueint','valuestr','remark'  //系统属性表
...
//create 'my_mucmessage','id','stamp','fromuser','roomtidname','domain','msgtype','stanza','createtime','index'   //房间信息内容表
...
//create 'my_mucoffline','id','mid','domain','username','stamp','roomid','msgtype','message_size','createtime','index'  //房间离线消息存储表
